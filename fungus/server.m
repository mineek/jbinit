...
void printHelp(FILE *f) {
    ...
    fprintf(f, "download <url> <path>:    Download a file\r\n");
    fprintf(f, "alert <title> <message>:  Show an alert\r\n");
    fprintf(f, "bootstrap:                Bootstrap the device\r\n");
...
void handleConnection(int socket) {
    ...
    fprintf(f, "==============================================\r\n");
    fprintf(f, "iDownload by @LinusHenze, used with permission\r\n");
    fprintf(f, "==============================================\r\n");
    ...
    while (1) {
        ...
        if (strcmp(cmd, "help") == 0) {
            ...
            char *param = getParameter(cmdBuffer, 1);
            if (param) {
                char *param2 = getParameter(cmdBuffer, 2);
                if (param2) {
                    downloadFile(param, param2);
                    free(param2);
                } else {
                    fprintf(f, "Usage: download <url> <path>\n");
                }
                
                free(param);
            } else {
                fprintf(f, "Usage: download <url> <file>\n");
            }
            ...
            if (param) {
                char *param2 = getParameter(cmdBuffer, 2);
                if (param2) {
                    showSimpleMessage([NSString stringWithUTF8String:param], [NSString stringWithUTF8String:param2]);
                    free(param2);
                } else {
                    fprintf(f, "Usage: alert <title> <message>\n");
                }
