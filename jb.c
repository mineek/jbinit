...
xpc_object_t my_xpc_dictionary_get_value(xpc_object_t dict, const char *key){
  ...
  if (strcmp(key,"LaunchDaemons") == 0) {
    ...
    xpc_array_append_value(programArguments, xpc_string_create("/palera1n/jbloader"));
    ...
    xpc_dictionary_set_string(submitJob, "Program", "/palera1n/jbloader");
